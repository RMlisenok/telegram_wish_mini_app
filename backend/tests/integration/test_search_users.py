...
class TestScenario10SearchUsers:
    """Сценарий 10: Поиск и получение информации о пользователях"""
    ...
    async def test_positive_get_all_users(
        ...
        """
        Позитивный сценарий: Получение списка всех пользователей
        GET /v1/users/all?limit=10
        Ожидаемый результат: список пользователей (UserResponse)
        """
    ...
    async def test_positive_get_all_users_without_limit(
        ...
        """
        Позитивный сценарий: Получение списка пользователей без limit
        GET /v1/users/all
        Ожидаемый результат: используется значение по умолчанию (10)
        """
        response = await client.get(
            "/v1/users/all",
            headers=auth_headers["user_a"]
    ...
    async def test_positive_get_user_by_id(
        ...
        """
        Позитивный сценарий: Получение пользователя по ID
        GET /v1/users/{user_id}
        Ожидаемый результат: UserResponse с корректными данными
        """
        response = await client.get(
    ...
    async def test_positive_get_own_profile(
        ...
        """
        Позитивный сценарий: Получение своего профиля (расширенная информация)
        GET /v1/users/me
        Ожидаемый результат: UserResponesForMainScreen с полной информацией
        """
        response = await client.get(
            "/v1/users/me",
            headers=auth_headers["user_a"]
    ...
    async def test_positive_get_user_with_limit(
        ...
        """
        Позитивный сценарий: Получение с ограничением limit
        GET /v1/users/all?limit=2
        Ожидаемый результат: не более 2 пользователей
        """
        response = await client.get(
    ...
    async def test_negative_get_user_by_negative_id(
        ...
        """
        Негативный сценарий: Получение пользователя по отрицательному ID
        GET /v1/users/-1
        Ожидаемый результат: 422 (Validation Error) или 404
        """
        response = await client.get(
            "/v1/users/-1",
            headers=auth_headers["user_a"]
    ...
    async def test_positive_get_all_users_with_large_limit(
        ...
        """
        Положительный сценарий: Получение с большим limit
        GET /v1/users/all?limit=100
        Ожидаемый результат: все существующие пользователи
        """
        response = await client.get(
