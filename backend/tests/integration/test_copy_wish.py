# tests/integration/test_scenario_8_copy_wish.py
import pytest


class TestScenario8CopyWish:
    """Сценарий 8: Копирование желания между вишлистами"""
    ...
    async def test_positive_copy_wish_to_another_wishlist(
        ...
        """
        Позитивный сценарий: Копирование желания из вишлиста A в вишлист B
        POST /v1/wishlists/{wishlist_id}/wishes - с тем же wish_id в другой вишлист
        """
    ...
    async def test_negative_copy_to_nonexistent_wishlist(
        ...
        """
        Негативный сценарий: Копирование в несуществующий вишлист
        """
        # Создаем желание
        wish_data = {
    ...
    async def test_negative_copy_nonexistent_wish(
        ...
        """
        Негативный сценарий: Копирование несуществующего желания
        """
        ...
        assert response.status_code == 400
        assert "Failed to add wish to wishlist" in response.json().get("detail", "")