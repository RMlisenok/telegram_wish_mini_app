...
INTEREST_TAGS = [
    ...
    "книги", "научпоп", "саморазвитие", "иностранные языки", "компьютерные игры",
    "настольные игры", "рукоделие", "сад и огород", "домашний декор", "спорт",
    "танцы", "технологии и наука", "3Д-моделирование и графика", "робототехника",
...
AVOID_TAGS = [
    ...
    "алкоголь", "мягкие игрушки", "домашний декор", "книги", "подарочные сертификаты"
]
